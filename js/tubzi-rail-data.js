...
window.TUBZI_RAIL = {
    ...
    structure: [
        ...
        { kind: "item", id: "sports-games", label: "Sports Games", icon: "sports", categoryId: "sports-games", genre: "sports" },
        { kind: "item", id: "multiplayer-games", label: "Multiplayer Games", icon: "multiplayer", categoryId: "multiplayer-games", genre: "io" },
        { kind: "item", id: "io-games", label: "IO Games", icon: "io", categoryId: "io-games", genre: "io" },
        { kind: "item", id: "puzzle-games", label: "Puzzle Games", icon: "puzzle", categoryId: "puzzle-games", genre: "puzzle" },
        { kind: "item", id: "adventure-games", label: "Adventure Games", icon: "school", categoryId: "adventure-games", genre: "action" },
        { kind: "item", id: "arcade-games", label: "Arcade Games", icon: "arcade", categoryId: "arcade-games", genre: "casual" },
        { kind: "item", id: "clicker-idle-games", label: "Clicker / Idle Games", icon: "sandbox", categoryId: "clicker-idle-games", genre: "casual" },
        { kind: "item", id: "horror-games", label: "Horror Games", icon: "dmca", categoryId: "horror-games", genre: "horror" },
        { kind: "item", id: "platformer-games", label: "Platformer Games", icon: "runners", categoryId: "platformer-games", genre: "platformer" },
