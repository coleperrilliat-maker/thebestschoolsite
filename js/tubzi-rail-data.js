...
window.TUBZI_RAIL = {
    ...
    structure: [
        ...
        { kind: "item", id: "io", label: "IO", icon: "io", genre: "io" },
        { kind: "item", id: "sports", label: "Sports", icon: "sports", genre: "sports" },
        { kind: "item", id: "driving", label: "Driving", icon: "driving", genre: "driving" },
        { kind: "item", id: "action", label: "Action", icon: "action", genre: "action" },
        { kind: "item", id: "puzzle", label: "Puzzle", icon: "puzzle", genre: "puzzle" },
        { kind: "item", id: "casual", label: "Casual", icon: "casual", genre: "casual" },
